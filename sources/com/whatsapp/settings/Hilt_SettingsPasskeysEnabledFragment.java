...
public abstract class Hilt_SettingsPasskeysEnabledFragment extends AnonymousClass02E implements C18700tb {
    ...
    public void A1F(android.app.Activity r4) {
        ...
        L_0x000f:
            ...
            X.3EF r0 = X.C32581dr.A0c(r0)
            r1.A00 = r0
        L_0x002c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.whatsapp.settings.Hilt_SettingsPasskeysEnabledFragment.A1F(android.app.Activity):void");
    }
    ...
    public void A1O(Context context) {
        ...
        if (!this.A00) {
            this.A00 = true;
            ((SettingsPasskeysEnabledFragment) this).A00 = C32581dr.A0c((C32581dr) ((C32571dq) generatedComponent()));
        }
    }
