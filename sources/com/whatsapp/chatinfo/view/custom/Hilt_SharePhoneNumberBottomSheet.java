...
public abstract class Hilt_SharePhoneNumberBottomSheet extends PnhBottomSheet {
    ...
    public void A1h() {
        if (!this.A02) {
            ...
            C18830tt r1 = r2.A00;
            C36321k7.A0l(r1, sharePhoneNumberBottomSheet);
            sharePhoneNumberBottomSheet.A01 = C36341k9.A0V(r2);
            sharePhoneNumberBottomSheet.A02 = C36351kA.A0p(r1);
            sharePhoneNumberBottomSheet.A00 = C36381kD.A0V(r2);
        }
    }
