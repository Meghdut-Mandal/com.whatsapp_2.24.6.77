...
public abstract class Hilt_PaymentOptionsBottomSheet extends WDSBottomSheetDialogFragment {
    ...
    public void A1h() {
        if (!this.A02) {
            ...
            C18830tt r1 = r2.A00;
            C90504aG.A18(r1, paymentOptionsBottomSheet);
            paymentOptionsBottomSheet.A02 = C36341k9.A0V(r2);
            paymentOptionsBottomSheet.A01 = C36351kA.A0U(r2);
            paymentOptionsBottomSheet.A04 = (C23075B3f) r1.A0R.get();
            paymentOptionsBottomSheet.A00 = (AnonymousClass1LB) r2.ADr.get();
        }
    }
