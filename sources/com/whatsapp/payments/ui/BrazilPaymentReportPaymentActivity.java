...
public class BrazilPaymentReportPaymentActivity extends AnonymousClass24a {
    public AnonymousClass2a4 A00;
    public boolean A01;
    ...
    public void A2F() {
        if (!this.A01) {
            ...
            this.A00 = (AnonymousClass2a4) A0L.A0E.get();
        }
    }

    public BrazilPaymentReportPaymentActivity(int i) {
        this.A01 = false;
        C89344We.A00(this, 44);
    }
