...
public abstract class Hilt_CommunityHomeFragment extends WaFragment {
    ...
    public void A1Y() {
        if (!this.A02) {
            ...
            C18800tq r1 = r3.A1K;
            C36341k9.A1B(r1, communityHomeFragment);
            communityHomeFragment.A02 = C36351kA.A0T(r1);
            communityHomeFragment.A00 = (C58172zR) r3.A0W.get();
            communityHomeFragment.A03 = (C220712t) r1.A1b.get();
        }
    }
