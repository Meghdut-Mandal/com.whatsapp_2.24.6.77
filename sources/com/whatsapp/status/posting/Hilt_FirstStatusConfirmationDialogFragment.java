...
public abstract class Hilt_FirstStatusConfirmationDialogFragment extends WaDialogFragment {
    ...
    public void A1h() {
        if (!this.A02) {
            ...
            C36321k7.A0g(r1, firstStatusConfirmationDialogFragment);
            firstStatusConfirmationDialogFragment.A03 = C36341k9.A0Z(r1);
            firstStatusConfirmationDialogFragment.A02 = C36391kE.A0e(r1);
            firstStatusConfirmationDialogFragment.A00 = (AnonymousClass164) r1.A99.get();
            firstStatusConfirmationDialogFragment.A01 = (C144576sT) r1.A8T.get();
        }
    }
