...
public abstract class Hilt_BusinessDirectoryPopularApiBusinessesFragment extends AnonymousClass02E implements C18700tb {
    ...
    public void A1F(android.app.Activity r4) {
        ...
        L_0x000f:
            ...
            X.1dr r0 = (X.C32581dr) r0
            X.4mR r0 = X.C32581dr.A0Z(r0)
            r1.A01 = r0
        L_0x002c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.whatsapp.businessdirectory.view.fragment.Hilt_BusinessDirectoryPopularApiBusinessesFragment.A1F(android.app.Activity):void");
    }
    ...
    public void A1O(Context context) {
        ...
        if (!this.A00) {
            this.A00 = true;
            ((BusinessDirectoryPopularApiBusinessesFragment) this).A01 = C32581dr.A0Z((C32581dr) ((C32571dq) generatedComponent()));
        }
    }
