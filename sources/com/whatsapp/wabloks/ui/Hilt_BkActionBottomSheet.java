...
public abstract class Hilt_BkActionBottomSheet extends RoundedBottomSheetDialogFragment {
    ...
    public void A1h() {
        if (!this.A02) {
            ...
            C18800tq r1 = r3.A1K;
            C90464aC.A12(r1.A00, bkActionBottomSheet);
            bkActionBottomSheet.A02 = C18840tu.A00(r1.ABk);
            bkActionBottomSheet.A01 = C90484aE.A0a(r1);
            C27111My r12 = r3.A1I;
            bkActionBottomSheet.A00 = (AnonymousClass60P) r12.A3V.get();
            bkActionBottomSheet.A03 = C27111My.A02(r12);
        }
    }
