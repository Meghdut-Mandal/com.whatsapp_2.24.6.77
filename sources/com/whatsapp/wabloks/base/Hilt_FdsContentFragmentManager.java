...
public abstract class Hilt_FdsContentFragmentManager extends AnonymousClass02E implements C18700tb {
    ...
    public void A1F(android.app.Activity r4) {
        ...
        L_0x000f:
            ...
            X.0tq r0 = r0.A1K
            X.6Ou r0 = X.C90484aE.A0a(r0)
            r1.A00 = r0
        L_0x002e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.whatsapp.wabloks.base.Hilt_FdsContentFragmentManager.A1F(android.app.Activity):void");
    }
    ...
    public void A1O(Context context) {
        ...
        if (!this.A00) {
            this.A00 = true;
            ((FdsContentFragmentManager) this).A00 = C90484aE.A0a(((C32581dr) ((C32571dq) generatedComponent())).A1K);
        }
    }
