...
public abstract class Hilt_GroupPendingInvitesFragment extends AnonymousClass02E implements C18700tb {
    ...
    public void A1F(android.app.Activity r4) {
        ...
        L_0x000f:
            ...
            r0 = r3
            com.whatsapp.group.GroupPendingInvitesFragment r0 = (com.whatsapp.group.GroupPendingInvitesFragment) r0
            X.1dr r1 = (X.C32581dr) r1
            X.C32581dr.A1A(r1, r0)
        L_0x0029:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.whatsapp.group.Hilt_GroupPendingInvitesFragment.A1F(android.app.Activity):void");
    }
    ...
    public void A1O(Context context) {
        ...
        if (!this.A00) {
            this.A00 = true;
            C32581dr.A1A((C32581dr) ((C32571dq) generatedComponent()), (GroupPendingInvitesFragment) this);
        }
    }
