...
public class Log {
    ...
    public static final C18920u2 LOGGER_THREAD;
    ...
    public static C19690wM connectivityInfoProvider = null;
    ...
    public static void flush() {
        try {
            ...
            if (Thread.currentThread() == r4) {
                ...
                FutureTask futureTask = new FutureTask(C18920u2.A05, (Object) null);
                C18920u2.A01(r4, futureTask);
    ...
    public static java.io.File compress() {
        ...
        L_0x004d:
            ...
            java.lang.String r3 = X.AnonymousClass6UF.A00(r5, r0, r1)     // Catch:{ IOException | SecurityException -> 0x0139 }
    ...
    public static ArrayList getLatestLogs(int i) {
        ...
        String A02 = AnonymousClass6UF.A02(file.getName(), ".gz");
        String A01 = AnonymousClass6UF.A01(file.getName());
    ...
    public static String adorn(String str, StringBuilder sb) {
        ...
        sb3.append(str);
        C19690wM r0 = connectivityInfoProvider;
        if (r0 != null) {
