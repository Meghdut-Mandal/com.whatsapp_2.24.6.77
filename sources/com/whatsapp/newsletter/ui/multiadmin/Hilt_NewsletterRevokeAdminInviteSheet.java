...
public abstract class Hilt_NewsletterRevokeAdminInviteSheet extends WDSBottomSheetDialogFragment {
    ...
    public void A1h() {
        if (!this.A02) {
            ...
            C18830tt r1 = r2.A00;
            C36361kB.A1E(r1, newsletterRevokeAdminInviteSheet);
            newsletterRevokeAdminInviteSheet.A03 = C36351kA.A0V(r2);
            newsletterRevokeAdminInviteSheet.A04 = (C62403Ga) r1.AA8.get();
            newsletterRevokeAdminInviteSheet.A00 = C36351kA.A0M(r2);
            newsletterRevokeAdminInviteSheet.A02 = C36351kA.A0U(r2);
            newsletterRevokeAdminInviteSheet.A06 = (AnonymousClass3E8) r1.AAA.get();
            newsletterRevokeAdminInviteSheet.A05 = (C64573On) r1.AAD.get();
        }
    }
