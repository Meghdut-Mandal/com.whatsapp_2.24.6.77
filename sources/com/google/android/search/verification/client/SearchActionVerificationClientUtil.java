...
public abstract class SearchActionVerificationClientUtil {
    ...
    public static boolean isPackageGoogleSigned(Context context, String str) {
        try {
            ...
            A1Q[0] = str;
            AnonymousClass000.A1N(A1Q, 1, equals);
            AnonymousClass000.A1N(A1Q, 2, equals2);
            Log.d(TAG, String.format("Package %s GSA signed status %s AssistantGo signed status %s", A1Q));
            if (equals || equals2) {
                return true;
            }
            return false;
            ...
            C90464aC.A1G("Unexpected NameNotFoundException: ", valueOf, TAG, C90524aI.A0h(C90474aD.A05(valueOf) + 34));
            return false;
        }
    }
    ...
    public static void logIntentWithExtras(Intent intent) {
        ...
        C90464aC.A1G("\t", valueOf, TAG, C90524aI.A0h(C90474aD.A05(valueOf) + 1));
        ...
        if (extras != null) {
            ...
            while (it.hasNext()) {
                ...
                Object[] A1a = C90474aD.A1a(A0C);
                A1a[1] = extras.get(A0C);
    ...
    public static boolean isPackageWhitelisted(Context context, boolean z) {
        ...
        if (z && PublicKeyCredentialControllerUtility.JSON_KEY_USER.equals(Build.TYPE) && !isPackageGoogleSigned(context, nameForUid)) {
            A0c = "Package is not Google signed!";
            ...
            A0c = C90464aC.A0c("Access is not allowed for package: ", nameForUid);
        }
        Log.d(TAG, A0c);
        return false;
    }
