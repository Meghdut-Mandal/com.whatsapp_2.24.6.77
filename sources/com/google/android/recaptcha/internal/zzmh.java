...
public abstract class zzmh {
    ...
    public static String zzb(String str, byte[] bArr, zzmi zzmi) {
        ...
        if (bArr4.length == 32) {
            ...
            int i3 = 4;
            do {
                iArr2[i3] = zze(bArr4, (i3 - 4) * 4);
                i3++;
            } while (i3 < 12);
            iArr2[12] = 1;
            int i4 = 13;
            do {
                iArr2[i4] = zze(bArr2, (i4 - 13) * 4);
                i4++;
            } while (i4 < 16);
            ...
            while (length > 0) {
                ...
                do {
                    ...
                    int[] iArr5 = iArr2;
                    int[] iArr6 = iArr3;
                    zzc(0, 4, 8, 12, iArr4, bArr6, bArr7, i5, iArr5, iArr6);
                    ...
                    zzc(0, 5, 10, 15, iArr4, bArr6, bArr7, i5, iArr5, iArr6);
                ...
                do {
                    ...
                    bArr8[i10 + 3] = (byte) ((i9 >> 24) & 255);
                    i8++;
                } while (i8 < 16);
                for (int i11 = 0; i11 < Math.min(64, length); i11++) {
                    int i12 = i6 + i11;
                    bArr5[i12] = (byte) zza(bArr8[i11], bArr3[i12]);
                }
                i5++;
                length -= 64;
                i6 += 64;
