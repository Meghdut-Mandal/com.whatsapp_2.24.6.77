...
public abstract class zzgb {
    ...
    public static long zza(long j, long j2) {
        boolean z = true;
        boolean A1P = C36431kI.A1P(((j ^ j2) > 0 ? 1 : ((j ^ j2) == 0 ? 0 : -1)));
        long j3 = j + j2;
        if ((j ^ j3) < 0) {
            z = false;
        }
        zzgc.zza(A1P | z, "checkedAdd", j, j2);
        return j3;
    }

    public static long zzb(long j, long j2) {
        boolean z = true;
        boolean A1U = C36401kF.A1U(((1 ^ j) > 0 ? 1 : ((1 ^ j) == 0 ? 0 : -1)));
        long j3 = -1 + j;
        if ((j ^ j3) < 0) {
            z = false;
        }
        zzgc.zza(A1U | z, "checkedSubtract", j, 1);
        return j3;
    }
}
