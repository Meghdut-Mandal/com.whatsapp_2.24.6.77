...
public final class C07500Xy {
    public final float[] A00;
    public final int[] A01;

    public C07500Xy(List list, List list2) {
        int size = list.size();
        this.A01 = new int[size];
        this.A00 = new float[size];
        for (int i = 0; i < size; i++) {
            this.A01[i] = AnonymousClass000.A0I(list.get(i));
            this.A00[i] = ((Number) list2.get(i)).floatValue();
        }
    }

    public C07500Xy(int i, int i2, int i3) {
        this.A01 = new int[]{i, i2, i3};
        this.A00 = new float[]{0.0f, 0.5f, 1.0f};
    }

    public C07500Xy(int i, int i2) {
