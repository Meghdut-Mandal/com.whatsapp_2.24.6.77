...
public final class C50882mn extends WDSButton implements C22928Aye {
    public C19730wQ A00;
    public C28391Sm A01;
    public C20230xE A02;
    public AnonymousClass1Sk A03;
    public C19770wU A04;
    public boolean A05;

    public C50882mn(Context context) {
    ...
    public void A04() {
        if (!this.A05) {
            ...
            this.A03 = C36431kI.A0Z(A0W);
            this.A01 = C18800tq.A4s(A0W);
            this.A02 = C18800tq.A4u(A0W);
