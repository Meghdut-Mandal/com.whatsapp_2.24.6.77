...
public final class AnonymousClass9MC {
    public final int A00;
    public final AnonymousClass9UL A01;
    ...
    public AnonymousClass9MC(java.lang.String r3, byte[] r4, byte[] r5, int r6, int r7, int r8, boolean r9) {
        /*
            r2 = this;
            r2.<init>()
            r1 = 1
            boolean r0 = X.AnonymousClass000.A1Q(r6)
        ...
        L_0x0051:
            ...
            goto L_0x0038
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass9MC.<init>(java.lang.String, byte[], byte[], int, int, int, boolean):void");
    }
}
