...
public abstract class AnonymousClass8YX extends AnonymousClass2IR {
    public boolean A00;

    public void A16() {
        if (!this.A00) {
            this.A00 = true;
            AnonymousClass2IG r5 = (AnonymousClass2IG) this;
            ...
            AnonymousClass3R2.A01(r5, (C62163Fa) r2.A5p.get());
            AnonymousClass3R2.A00(A0k, r5);
            AnonymousClass3R2.A02(r5, C36371kC.A0l(r4));
        }
    }

    public AnonymousClass8YX(Context context, C89004Uw r2, AnonymousClass3T1 r3) {
        super(context, r2, r3);
        A16();
    }
}
