...
public final class C79913uU implements B0B {
    ...
    public boolean B1C(C193229Kn r9, C16540pP r10, C87374On r11) {
        ...
        int A0O = r3.A0O("privacy_groupadd", 0);
        long A0V = r3.A0V("privacy_tip_exit_group_timestamp");
        if (((int) A0V) == -1) {
            return false;
        }
        long j = A0V + millis;
    ...
    public C79913uU(C19760wT r1, C19420v0 r2, C20810yC r3) {
