...
public final class C201299jI {
    ...
    public static C201299jI A00(int i, int i2) {
        int bitCount;
        int[][] iArr = A02;
        ...
        if (i3 <= 3) {
            return new C201299jI(i5);
        }
        return null;
    }

    public boolean equals(Object obj) {
        if (obj instanceof C201299jI) {
            C201299jI r4 = (C201299jI) obj;
    ...
    public C201299jI(int i) {
        int i2 = (i >> 3) & 3;
        if (i2 >= 0) {
            Integer[] numArr = C196679aM.A00;
            if (i2 < 4) {
                this.A01 = numArr[i2];
                this.A00 = (byte) (i & 7);
                return;
