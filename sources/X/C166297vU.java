...
public class C166297vU extends View.BaseSavedState {
    public static final Parcelable.Creator CREATOR = C23180B8o.A00(18);
    public int A00 = -1;
    public int A01;
    public int A02;
    public int A03;
    ...
    public C166297vU(Parcel parcel) {
        super(parcel);
    ...
    public C166297vU(Parcelable parcelable) {
        super(parcelable);
    }
}
