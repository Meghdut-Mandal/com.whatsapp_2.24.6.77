...
public abstract class AnonymousClass8ZU extends AnonymousClass2IQ {
    public boolean A00;

    public void A16() {
        if (!this.A00) {
            this.A00 = true;
            AnonymousClass2IO r5 = (AnonymousClass2IO) this;
            ...
            AnonymousClass8ZJ.A0Y(A0k, r4, r2, r5);
            AnonymousClass8ZJ.A0Z(r4, r2, r6, r5);
        }
    }

    public AnonymousClass8ZU(Context context, C89004Uw r2, AnonymousClass2bU r3) {
        super(context, r2, r3);
        A16();
    }
}
