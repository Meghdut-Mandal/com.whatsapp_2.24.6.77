...
public final class AnonymousClass6CP {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof AnonymousClass6CP) {
                AnonymousClass6CP r5 = (AnonymousClass6CP) obj;
    ...
    public AnonymousClass6CP(Integer num, PublicKey publicKey, X509Certificate x509Certificate, X509Certificate x509Certificate2) {
    ...
    public String toString() {
        ...
        A0u.append("SupportCertificate(encryptionCertificate=");
        A0u.append(this.A02);
