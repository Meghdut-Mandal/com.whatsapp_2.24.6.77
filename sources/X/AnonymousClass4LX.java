...
public final class AnonymousClass4LX extends AnonymousClass00R implements C006302t {
    public final /* synthetic */ UpdatesAdapter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AnonymousClass4LX(UpdatesAdapter updatesAdapter) {
        super(1);
            ...
            if (observableRecyclerView == null || (layoutManager = observableRecyclerView.getLayoutManager()) == null) {
                ...
                for (int i2 = 0; i2 < A0L; i2++) {
                    ...
                    if (A0R != null) {
                        ...
                        if ((tag instanceof C48022gZ) && ((C48022gZ) tag).A05) {
                            arrayList.add(A0R);
