...
public class C21754AZi implements B35 {
    ...
    public static void A02(String str, byte[] bArr) {
        A03.put(AnonymousClass11q.A01(str), bArr);
    }
    ...
    public void BKQ(C16590pl r6, boolean z) {
        if (r6 instanceof C21757AZl) {
            byte[] bArr = ((C21757AZl) r6).A00;
            if (bArr.length == A0C.length) {
                this.A01 = AnonymousClass124.A02(bArr);
                return;
            }
            throw AnonymousClass001.A08("invalid S-box passed to GOST28147 init");
        } else if (r6 instanceof AZr) {
            byte[] bArr2 = ((AZr) r6).A00;
            this.A00 = z;
            if (bArr2.length == 32) {
                int[] iArr = new int[8];
                int i = 0;
            ...
            throw AnonymousClass001.A08("Key length invalid. Key needs to be 32 byte - 256 bit!!!");
        } else if (r6 != null) {
            throw C165567td.A0N(r6, "invalid parameter passed to GOST28147 init - ", AnonymousClass000.A0u());
        }
    }
    ...
    public int BmM(byte[] r12, byte[] r13, int r14, int r15) {
        /*
            r11 = this;
            int[] r5 = r11.A02
        ...
        L_0x005a:
            ...
            int r1 = r15 + 2
            int r0 = r2 >>> 16
            int r1 = X.C165617ti.A02(r0, r13, r1, r15)
            int r0 = r2 >>> 8
            byte r0 = (byte) r0
            r13[r1] = r0
            byte r0 = (byte) r2
            ...
            int r1 = r2 + 2
            int r0 = r4 >>> 16
            int r1 = X.C165617ti.A02(r0, r13, r1, r2)
            int r0 = r4 >>> 8
            byte r0 = (byte) r0
            r13[r1] = r0
            byte r0 = (byte) r4
        ...
        L_0x0092:
            ...
            goto L_0x0054
        L_0x00a5:
            X.At1 r0 = X.C22697At1.A00()
            throw r0
        L_0x00aa:
            X.At6 r0 = X.C22702At6.A01()
            throw r0
        L_0x00af:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C21754AZi.BmM(byte[], byte[], int, int):int");
    }
}
