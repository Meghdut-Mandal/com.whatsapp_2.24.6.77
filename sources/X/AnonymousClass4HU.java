...
public final class AnonymousClass4HU extends AnonymousClass00R implements AnonymousClass00S {
    ...
    public AnonymousClass4HU(AnonymousClass02E r2, Enum enumR) {
        super(0);
    ...
    public /* bridge */ /* synthetic */ Object invoke() {
        ...
        if (!(bundle == null || (string = bundle.getString(this.$key)) == null)) {
            try {
                obj = Enum.valueOf(C51432no.class, string);
            } catch (Throwable th) {
