...
public abstract class C07630Yq {
    public static int A00(Object obj) {
        if (Build.VERSION.SDK_INT >= 28) {
            return AnonymousClass0YL.A00(obj);
        }
        try {
            return AnonymousClass000.A0I(AnonymousClass000.A0h(obj.getClass(), obj, "getResId"));
    ...
    public static int A01(Object obj) {
        if (Build.VERSION.SDK_INT >= 28) {
            return AnonymousClass0YL.A01(obj);
        }
        try {
            return AnonymousClass000.A0I(AnonymousClass000.A0h(obj.getClass(), obj, "getType"));
        } catch (IllegalAccessException | NoSuchMethodException | InvocationTargetException e) {
            Log.e("IconCompat", AnonymousClass000.A0l(obj, "Unable to get icon type ", AnonymousClass000.A0u()), e);
            return -1;
        }
    }
    ...
    public static android.graphics.drawable.Icon A03(android.content.Context r4, androidx.core.graphics.drawable.IconCompat r5) {
        ...
        L_0x0045:
            ...
            android.graphics.drawable.Icon r2 = X.C05390Pn.A00(r0)
        L_0x0053:
        ...
        L_0x0070:
            ...
            android.graphics.drawable.Icon r2 = X.C05380Pm.A00(r0)
            goto L_0x0053
        L_0x0077:
        ...
        L_0x0096:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C07630Yq.A03(android.content.Context, androidx.core.graphics.drawable.IconCompat):android.graphics.drawable.Icon");
    }

    public static Uri A04(Object obj) {
        if (Build.VERSION.SDK_INT >= 28) {
            return AnonymousClass0YL.A02(obj);
        }
        try {
            return (Uri) AnonymousClass000.A0h(obj.getClass(), obj, "getUri");
        } catch (IllegalAccessException | NoSuchMethodException | InvocationTargetException e) {
    ...
    public static String A05(Object obj) {
        if (Build.VERSION.SDK_INT >= 28) {
            return AnonymousClass0YL.A03(obj);
        }
        try {
            return (String) AnonymousClass000.A0h(obj.getClass(), obj, "getResPackage");
        } catch (IllegalAccessException | NoSuchMethodException | InvocationTargetException e) {
