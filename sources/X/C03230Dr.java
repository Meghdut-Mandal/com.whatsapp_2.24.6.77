...
public class C03230Dr extends Drawable {
    public float A00;
    public float A01;
    ...
    public static void A00(Rect rect, C03230Dr r11) {
        if (rect == null) {
            rect = r11.getBounds();
        }
        RectF rectF = r11.A0A;
        ...
        if (r11.A03) {
            ...
            float f3 = f * 1.5f;
            if (z) {
                double d2 = (1.0d - C03200Do.A00) * ((double) f2);
    ...
    public boolean onStateChange(int[] iArr) {
        ...
        this.A07 = AnonymousClass000.A0V(colorStateList2, mode, this);
        return true;
    }
    ...
    public C03230Dr(ColorStateList colorStateList, float f) {
        this.A01 = f;
