...
public abstract class C203079nF {
    public static final ThreadLocal A00 = new C21844AbM();
    public static final float A01 = ((float) (Math.sqrt(2.0d) / 2.0d));
    public static final ThreadLocal A02 = new C21841AbJ();
    public static final ThreadLocal A03 = new C21842AbK();
    public static final ThreadLocal A04 = new C21843AbL();
    ...
    public static void A03(Path path, float f, float f2, float f3) {
        ...
        if (!(f == 1.0f && f2 == 0.0f) && length >= 1.0f && ((double) C90494aF.A01(f2 - f, 1.0f)) >= 0.01d) {
            float f4 = f * length;
            float f5 = f2 * length;
            float f6 = f3 * length;
            ...
            if (min >= length && max >= length) {
                min = (float) C200579hd.A00(min, length);
                max = (float) C200579hd.A00(max, length);
            }
            if (min < 0.0f) {
                min = (float) C200579hd.A00(min, length);
            }
