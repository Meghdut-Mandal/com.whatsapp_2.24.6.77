...
public class AnonymousClass0I5 extends C02910Cj implements C17220qv {
    ...
    public final AnonymousClass0UE A0P;
    ...
    public void A07(int r5) {
        ...
        L_0x003b:
            ...
            goto L_0x0018
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass0I5.A07(int):void");
    }
    ...
    public void A04(Canvas canvas, AnonymousClass0C4 r11, RecyclerView recyclerView) {
        ...
        if (i2 != recyclerView2.getWidth() || this.A05 != recyclerView2.getHeight()) {
            ...
            if (this.A0C) {
                ...
                if (AnonymousClass04F.A01(recyclerView2) == 1) {
    ...
    public void A06() {
        ...
        valueAnimator.setFloatValues(new float[]{AnonymousClass000.A00(valueAnimator), 1.0f});
    ...
    public boolean A08(float f, float f2) {
        if (AnonymousClass04F.A01(this.A0A) != 1 ? f >= ((float) (this.A06 - this.A0I)) : f <= ((float) (this.A0I / 2))) {
            int i = this.A08;
            int i2 = this.A09 / 2;
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean BZG(android.view.MotionEvent r9, androidx.recyclerview.widget.RecyclerView r10) {
        /*
            r8 = this;
            int r0 = r8.A07
            r7 = 0
        ...
        L_0x0060:
            ...
            goto L_0x0051
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass0I5.BZG(android.view.MotionEvent, androidx.recyclerview.widget.RecyclerView):boolean");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void BjE(android.view.MotionEvent r13, androidx.recyclerview.widget.RecyclerView r14) {
        /*
            r12 = this;
            int r0 = r12.A07
        ...
        L_0x012f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass0I5.BjE(android.view.MotionEvent, androidx.recyclerview.widget.RecyclerView):void");
    }

    public AnonymousClass0I5(Drawable drawable, Drawable drawable2, StateListDrawable stateListDrawable, StateListDrawable stateListDrawable2, RecyclerView recyclerView, int i, int i2, int i3) {
        ValueAnimator ofFloat = ValueAnimator.ofFloat(new float[]{0.0f, 1.0f});
        this.A0K = ofFloat;
        this.A02 = 0;
        this.A0Q = new C11240fx(this);
        this.A0P = new AnonymousClass0IA(this);
        ...
        ofFloat.addListener(new AnonymousClass0DI(this));
        ofFloat.addUpdateListener(new AnonymousClass0ZJ(this));
        RecyclerView recyclerView2 = this.A0A;
        if (recyclerView2 != recyclerView) {
            if (recyclerView2 != null) {
                recyclerView2.A0u(this);
                RecyclerView recyclerView3 = this.A0A;
                recyclerView3.A13.remove(this);
                if (recyclerView3.A0K == this) {
            ...
            recyclerView.A0t(this);
            RecyclerView recyclerView4 = this.A0A;
            recyclerView4.A13.add(this);
            recyclerView4.A0v(this.A0P);
        }
    }
}
