...
public class AU4 implements Externalizable {
    public static final long serialVersionUID = 1;
    public int countryCode_ = 0;
    public AU2 emergency_ = null;
    public AU2 fixedLine_ = null;
    public AU2 generalDesc_ = null;
    ...
    public List intlNumberFormat_ = AnonymousClass001.A0I();
    public String leadingDigits_ = "";
    public boolean leadingZeroPossible_ = false;
    public boolean mainCountryForCode_ = false;
    public AU2 mobile_ = null;
    public String nationalPrefixForParsing_ = "";
    public String nationalPrefixTransformRule_ = "";
    public String nationalPrefix_ = "";
    public AU2 noInternationalDialling_ = null;
    public List numberFormat_ = AnonymousClass001.A0I();
    public AU2 pager_ = null;
    public AU2 personalNumber_ = null;
    public String preferredExtnPrefix_ = "";
    public String preferredInternationalPrefix_ = "";
    public AU2 premiumRate_ = null;
    public boolean sameMobileAndFixedLinePattern_ = false;
    public AU2 sharedCost_ = null;
    public AU2 tollFree_ = null;
    public AU2 uan_ = null;
    public AU2 voicemail_ = null;
    public AU2 voip_ = null;

    public static AU2 A00(ObjectInput objectInput) {
        AU2 au2 = new AU2();
        au2.readExternal(objectInput);
    ...
    public void writeExternal(ObjectOutput objectOutput) {
        ...
        for (int i = 0; i < size; i++) {
            ((AU3) this.numberFormat_.get(i)).writeExternal(objectOutput);
        }
        int A0F = C90484aE.A0F(this.intlNumberFormat_);
        objectOutput.writeInt(A0F);
        for (int i2 = 0; i2 < A0F; i2++) {
            ((AU3) this.intlNumberFormat_.get(i2)).writeExternal(objectOutput);
        }
    ...
    public void readExternal(ObjectInput objectInput) {
        if (objectInput.readBoolean()) {
            AU2 A00 = A00(objectInput);
            this.hasGeneralDesc = true;
            this.generalDesc_ = A00;
        }
        if (objectInput.readBoolean()) {
            AU2 A002 = A00(objectInput);
            this.hasFixedLine = true;
            this.fixedLine_ = A002;
        }
        if (objectInput.readBoolean()) {
            AU2 A003 = A00(objectInput);
            this.hasMobile = true;
            this.mobile_ = A003;
        }
        if (objectInput.readBoolean()) {
            AU2 A004 = A00(objectInput);
            this.hasTollFree = true;
            this.tollFree_ = A004;
        }
        if (objectInput.readBoolean()) {
            AU2 A005 = A00(objectInput);
            this.hasPremiumRate = true;
            this.premiumRate_ = A005;
        }
        if (objectInput.readBoolean()) {
            AU2 A006 = A00(objectInput);
            this.hasSharedCost = true;
            this.sharedCost_ = A006;
        }
        if (objectInput.readBoolean()) {
            AU2 A007 = A00(objectInput);
            this.hasPersonalNumber = true;
            this.personalNumber_ = A007;
        }
        if (objectInput.readBoolean()) {
            AU2 A008 = A00(objectInput);
            this.hasVoip = true;
            this.voip_ = A008;
        }
        if (objectInput.readBoolean()) {
            AU2 A009 = A00(objectInput);
            this.hasPager = true;
            this.pager_ = A009;
        }
        if (objectInput.readBoolean()) {
            AU2 A0010 = A00(objectInput);
            this.hasUan = true;
            this.uan_ = A0010;
        }
        if (objectInput.readBoolean()) {
            AU2 A0011 = A00(objectInput);
            this.hasVoicemail = true;
            this.voicemail_ = A0011;
        }
        if (objectInput.readBoolean()) {
            AU2 A0012 = A00(objectInput);
            this.hasEmergency = true;
            this.emergency_ = A0012;
        }
        if (objectInput.readBoolean()) {
            AU2 A0013 = A00(objectInput);
        ...
        for (int i = 0; i < readInt2; i++) {
            AU3 au3 = new AU3();
            au3.readExternal(objectInput);
            this.numberFormat_.add(au3);
        }
        int readInt3 = objectInput.readInt();
        for (int i2 = 0; i2 < readInt3; i2++) {
            AU3 au32 = new AU3();
            au32.readExternal(objectInput);
            this.intlNumberFormat_.add(au32);
        }
