...
public class C43212Fq extends C50302kX {
    public /* bridge */ /* synthetic */ Object A08(Object[] objArr) {
        ...
        if (!r2.isCancelled()) {
            ...
            while (it.hasNext()) {
                ...
                if (!A16.contains(A0h) && !A0f.A0G() && C50302kX.A04(this, A0f) && !this.A0B.contains(A0h) && !(A0h instanceof C177638e7) && !(A0h instanceof C177528dw) && A0M(A0f, A0K)) {
                    A0I3.add(A0f);
    ...
    public C43212Fq(C19730wQ r1, AnonymousClass16D r2, AnonymousClass185 r3, AnonymousClass171 r4, ContactPickerFragment contactPickerFragment, C18820ts r6, String str, HashSet hashSet, List list, List list2, List list3, List list4, Set set) {
