...
public final class AnonymousClass6CT {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof AnonymousClass6CT) {
                AnonymousClass6CT r5 = (AnonymousClass6CT) obj;
    ...
    public AnonymousClass6CT(Integer num, PublicKey publicKey, X509Certificate x509Certificate, X509Certificate x509Certificate2) {
    ...
    public String toString() {
        ...
        A0u.append("AvatarCertificate(encryptionCertificate=");
        A0u.append(this.A02);
