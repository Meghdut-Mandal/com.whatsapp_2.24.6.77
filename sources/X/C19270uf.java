...
public final class C19270uf {
    ...
    public static final synchronized void A03(C19270uf r2) {
        synchronized (r2) {
    ...
    public final synchronized int A04() {
        /*
            ...
            goto L_0x0059
        L_0x001f:
            boolean r0 = X.AnonymousClass0VW.A00()     // Catch:{ all -> 0x0072 }
            r2 = 1
        ...
        L_0x0072:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C19270uf.A04():int");
    }
    ...
    public C19270uf(Context context) {
        this.A04 = context;
    }

    public static String A01(C18960u7 r3) {
        C18960u7.A02(r3);
        C19000uB r1 = r3.A01;
        String str = r1.A01;
        if (str != null) {
