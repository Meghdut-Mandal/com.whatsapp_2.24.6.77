...
public final class AnonymousClass6AI {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof AnonymousClass6AI) {
                AnonymousClass6AI r5 = (AnonymousClass6AI) obj;
    ...
    public AnonymousClass6AI(String str, String str2) {
    ...
    public String toString() {
        ...
        A0u.append("SubmittedReport(responseId=");
        A0u.append(this.A00);
