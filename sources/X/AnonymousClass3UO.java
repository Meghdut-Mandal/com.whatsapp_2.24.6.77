...
public abstract class AnonymousClass3UO {
    ...
    public static boolean A01(int[] iArr) {
        ...
        if (AnonymousClass6XG.A03(A05, iArr[1])) {
            return true;
        }
        return false;
    }
    ...
    public static int[] A08(int[] iArr, int i) {
        boolean A032 = AnonymousClass6XG.A03(A05, i);
        boolean A012 = A01(iArr);
        if (A032) {
            if (!A012) {
                return A09(iArr, i);
            }
    ...
    public static boolean A02(int[] iArr) {
        int[] A062 = A06(AnonymousClass3TC.A04(iArr));
        switch (A062[0]) {
            case 128107:
            case 128108:
            case 128109:
    ...
    public static boolean A03(int[] r7) {
        /*
            int[] r7 = X.AnonymousClass3TC.A04(r7)
            r6 = 0
            r0 = r7[r6]
            switch(r0) {
        ...
        L_0x003f:
            ...
            r1 = r7[r1]
            int[] r0 = A05
            boolean r0 = X.AnonymousClass6XG.A03(r0, r1)
            return r0
        L_0x004a:
            r0 = 4
            ...
            goto L_0x003d
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass3UO.A03(int[]):boolean");
    }

    public static boolean A04(int[] iArr, int[] iArr2) {
        return Arrays.equals(iArr2, AnonymousClass3TC.A04(iArr));
    }

    public static int[] A06(int[] iArr) {
        ArrayList A0I = AnonymousClass001.A0I();
        for (int i : iArr) {
            if (!AnonymousClass6XG.A03(A05, i)) {
    ...
    public static int[] A07(int[] iArr) {
        int i;
        int[] A062 = A06(iArr);
        if (C64913Px.A02.contains(Integer.valueOf(A062[0]))) {
