...
public final class C105665Fo extends AnonymousClass5G4 implements C162097o1, C160467l3, AnonymousClass4VC, C162087o0 {
    public String A00;
    ...
    public C105665Fo(C116145k1 r2, AnonymousClass60Z r3, C147306x0 r4, AnonymousClass6DL r5, C147296wz r6, C105705Fs r7, C131376Ou r8, AnonymousClass6D3 r9) {
        super(r2, r3, r7);
    ...
    public void Bm2(AnonymousClass64K r8, String str, Map map, int i) {
        ...
        C90494aF.A10(obj);
        r1.A01(r8, (String) obj, str, A00(map), i);
    }

    public static final Map A00(Map map) {
        Map map2;
        String upperCase = C90464aC.A0a("fetch_channel", map).toUpperCase(Locale.ROOT);
        AnonymousClass00C.A08(upperCase);
        int ordinal = AnonymousClass5TA.valueOf(upperCase).ordinal();
        if (ordinal == 0) {
            ...
            C36341k9.A1J("should_load_bloks_through_cdn", true, r2, 0);
            C36341k9.A1J("static_url", obj3, r2, 1);
