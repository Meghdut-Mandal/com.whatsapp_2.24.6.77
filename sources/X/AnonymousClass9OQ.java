...
public class AnonymousClass9OQ {
    ...
    public AnonymousClass9OQ(byte b, short s, short s2, short s3, short s4, short s5, short s6, boolean z, boolean z2, boolean z3, boolean z4, boolean z5) {
        this.A01 = s;
        this.A0A = z;
        this.A00 = b;
        this.A07 = z2;
