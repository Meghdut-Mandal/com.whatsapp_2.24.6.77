...
public final class C132606Ul {
    public static C132606Ul A01;
    ...
    public final boolean A02() {
        ...
        try {
            packageInfo = C02640Bg.A00(this.A00).A00.getPackageManager().getPackageInfo("com.google.android.wearable.app.cn", 64);
        ...
        if (C02620Be.A02(this.A00)) {
            return A01(packageInfo, true);
        }
        boolean A012 = A01(packageInfo, false);
        if (A012 || !A01(packageInfo, true)) {
            return A012;
        }
    ...
    public C132606Ul(Context context) {
        this.A00 = context.getApplicationContext();
    }

    public static C132606Ul A00(Context context) {
        AnonymousClass006.A01(context);
        synchronized (C132606Ul.class) {
            if (A01 == null) {
                A01 = new C132606Ul(context);
            }
        }
        return A01;
    }
