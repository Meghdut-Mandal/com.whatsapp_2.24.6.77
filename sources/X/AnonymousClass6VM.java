...
public class AnonymousClass6VM {
    public final C19970wo A00;
    public final C24601Db A01;
    public final AnonymousClass6JP A02;
    public final AnonymousClass6WK A03;
    public final C000100b A04;

    public String A05(String str) {
        String A002 = A00(this, 1);
        if (!TextUtils.isEmpty(A002)) {
            byte[] bArr = (byte[]) JniBridge.jvidispatchOOO(13, A002.getBytes(), AnonymousClass000.A0p("C=US,ST=California,L=Menlo Park,O=Facebook,OU=WhatsApp,CN=", str, AnonymousClass000.A0u()).getBytes());
            if (bArr != null) {
    ...
    public static String A00(AnonymousClass6VM r1, int i) {
        PrivateKey A042 = r1.A03.A04(i);
        if (A042 == null) {
            return null;
        }
        StringBuilder A0u = AnonymousClass000.A0u();
        A0u.append("-----BEGIN PRIVATE KEY-----\r\n");
        A0u.append(Base64.encodeToString(A042.getEncoded(), 0));
        return AnonymousClass000.A0q("-----END PRIVATE KEY-----\r\n\u0000", A0u);
    }

    public static String A01(AnonymousClass6VM r7, String str, String str2) {
        if (!TextUtils.isEmpty(str2)) {
            try {
                ...
                String A002 = A00(r7, 1);
                if (!TextUtils.isEmpty(A002)) {
                    return AnonymousClass000.A0q(Base64.encodeToString((byte[]) JniBridge.jvidispatchOOO(12, join.getBytes(), A002.getBytes()), 11), C36331k8.A0k(join, "."));
                }
    ...
    public String A03(AF2 af2, String str) {
        String str2;
        try {
            ...
            String encodeToString = Base64.encodeToString(A0H, 11);
            JSONObject A1B = C36441kJ.A1B();
            ECPoint w = ((ECPublicKey) generateKeyPair.getPublic()).getW();
            try {
                A1B.put(PublicKeyCredentialControllerUtility.JSON_KEY_ALG, "ECDH-ES").put("enc", "A256GCM").put("epk", C36441kJ.A1B().put("kty", "EC").put("crv", "P-256").put("x", Base64.encodeToString(w.getAffineX().toByteArray(), 2)).put("y", Base64.encodeToString(w.getAffineY().toByteArray(), 2)));
            } catch (JSONException e) {
                Log.e("PAY: BrazilTokenizationHelper/generateEncodedEloHeader failed: ", e);
            }
            try {
                str2 = Base64.encodeToString(A1B.toString().getBytes(C19430v1.A0B), 11);
            ...
            try {
                PublicKey generatePublic = KeyFactory.getInstance("EC").generatePublic(new X509EncodedKeySpec(af2.A00));
                if (generatePublic != null) {
                    ...
                    try {
                        byte[] A022 = C203239na.A02(0);
                        byte[] A023 = C203239na.A02(0);
                        boolean z = true;
                        byte[] A024 = C203239na.A02(1);
                        byte[] bytes = "A256GCM".getBytes(C19430v1.A0B);
                        byte[] A025 = C203239na.A02(256);
                        ...
                        System.arraycopy(A024, 0, bArr4, 0, 4);
                        System.arraycopy(bArr2, 0, bArr4, 4, length);
                        System.arraycopy(C203239na.A02(length2), 0, bArr4, i, 4);
                        System.arraycopy(bytes, 0, bArr4, i2, length2);
                        System.arraycopy(A022, 0, bArr4, i3, 4);
                        System.arraycopy(A023, 0, bArr4, i4, 4);
                        System.arraycopy(A025, 0, bArr4, i5, 4);
                        if (i6 != i6) {
                            z = false;
                        }
                        C18740tg.A0E(z, "length doesn't match");
                        bArr3 = C90504aG.A0s().digest(bArr4);
                    ...
                    try {
                        bArr5 = this.A04.WCIAPIGcmAesCreateEncryptedCiphertext(bArr3, A0H, str.getBytes(C19430v1.A0B), bArr, 16);
    ...
    public AnonymousClass6VM(C19970wo r1, C24601Db r2, AnonymousClass6JP r3, AnonymousClass6WK r4, C000100b r5) {
        this.A00 = r1;
        this.A04 = r5;
        this.A01 = r2;
        this.A02 = r3;
    ...
    public static String A02(String str, String str2, String str3) {
        JSONObject A1B = C36441kJ.A1B();
        A1B.put("clientDeviceID", str);
        if (!TextUtils.isEmpty(str2)) {
            A1B.put("clientReferenceID", str2);
        }
        A1B.put("vProvisionedTokenID", str3);
        return C90484aE.A0l(String.valueOf(new SecureRandom().nextInt(100000)), "nonce", A1B);
    }

    public String A04(AF3 af3, String str) {
        BigInteger bigInteger;
        try {
            String A0l = C90484aE.A0l("PS256", PublicKeyCredentialControllerUtility.JSON_KEY_ALG, C36441kJ.A1B());
            PrivateKey A042 = this.A03.A04(1);
            String str2 = null;
            if (A042 != null) {
                try {
                    JSONObject put = C36441kJ.A1B().put("otp", str).put("certID", AnonymousClass6JP.A00(((RSAKey) A042).getModulus()));
                    AnonymousClass6JP r5 = this.A02;
                    String obj = put.toString();
                    AF3 af32 = af3;
                    try {
                        bigInteger = ((RSAPublicKey) C90464aC.A0l(af32.A06)).getModulus();
                    } catch (Exception e) {
                        try {
                            ...
                            StringBuilder A0u = AnonymousClass000.A0u();
                            C36341k9.A1O(A0u, C90494aF.A0c(e2, "PAY: JweCompactSerializer/encryptCek", A0u));
                            throw AnonymousClass001.A0B(e2);
                        } catch (Exception e3) {
                            Log.w("PAY: JweCompactSerializer/generateStepUpJweToken failed: ", e3);
                        }
                    }
                    String obj2 = C36441kJ.A1B().put(PublicKeyCredentialControllerUtility.JSON_KEY_ALG, "RSA-OAEP-256").put("enc", "A256GCM").put("typ", "JOSE").put("kid", AnonymousClass6JP.A00(bigInteger)).toString();
                    String str3 = C19430v1.A0B;
                    String encodeToString = Base64.encodeToString(obj2.getBytes(str3), 11);
                    byte[] bArr = new byte[32];
                    SecureRandom secureRandom = new SecureRandom();
                    secureRandom.nextBytes(bArr);
                    PublicKey A0l2 = C90464aC.A0l(af32.A06);
                    Cipher instance = Cipher.getInstance("RSA/ECB/OAEPwithSHA-256andMGF1Padding");
                    instance.init(1, A0l2);
                    ...
                    byte[] WCIAPIGcmAesCreateEncryptedCiphertext = r5.A00.WCIAPIGcmAesCreateEncryptedCiphertext(bArr, bArr2, bytes, encodeToString.getBytes("US-ASCII"), 16);
                    if (WCIAPIGcmAesCreateEncryptedCiphertext != null) {
                        ...
                        C90464aC.A1D(encodeToString2, encodeToString3, encodeToString4, strArr);
    ...
    public String A06(String str) {
        if (!TextUtils.isEmpty(str)) {
            ...
            if (!TextUtils.isEmpty(A002)) {
                return C36441kJ.A13((byte[]) JniBridge.jvidispatchOOO(14, str.getBytes(), A002.getBytes()));
            }
        }
        return null;
    }
    ...
    public java.lang.String A07(java.lang.String r11) {
        /*
            ...
            java.lang.String r4 = ""
            X.1Db r2 = r10.A01     // Catch:{ InvalidKeyException | NoSuchAlgorithmException -> 0x00a6 }
            ...
            goto L_0x0020
        L_0x001b:
            org.json.JSONObject r1 = X.C36441kJ.A1B()     // Catch:{ JSONException -> 0x002b, InvalidKeyException | NoSuchAlgorithmException -> 0x00a6 }
            goto L_0x0024
        L_0x0020:
            org.json.JSONObject r1 = X.C36441kJ.A1C(r0)     // Catch:{ JSONException -> 0x002b, InvalidKeyException | NoSuchAlgorithmException -> 0x00a6 }
        L_0x0024:
            ...
            goto L_0x0032
        L_0x002b:
            X.1Dc r1 = r2.A02     // Catch:{ InvalidKeyException | NoSuchAlgorithmException -> 0x00a6 }
            java.lang.String r0 = "Failed to get the wallet_secret"
            r1.A06(r0)     // Catch:{ InvalidKeyException | NoSuchAlgorithmException -> 0x00a6 }
        L_0x0032:
            X.6WK r1 = r10.A03     // Catch:{ InvalidKeyException | NoSuchAlgorithmException -> 0x00a6 }
            r0 = 5
            ...
            java.lang.String r0 = X.C19430v1.A0B     // Catch:{ UnsupportedEncodingException | InvalidAlgorithmParameterException | InvalidKeyException | NoSuchAlgorithmException | BadPaddingException | IllegalBlockSizeException | NoSuchPaddingException -> 0x0085, InvalidKeyException | NoSuchAlgorithmException -> 0x00a6 }
        ...
        L_0x0094:
            ...
            byte[] r0 = X.C110525ao.A00(r0, r1)     // Catch:{ InvalidKeyException | NoSuchAlgorithmException -> 0x00a6 }
        ...
        L_0x00ac:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass6VM.A07(java.lang.String):java.lang.String");
    }
    ...
    public String A08(String str, String str2, String str3) {
        try {
            ...
            A1B.put("typ", "JOSE");
            return A01(this, C90484aE.A0l(str, "kid", A1B), A02(str, str2, str3));
        } catch (JSONException e) {
