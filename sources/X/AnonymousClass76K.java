...
public final class AnonymousClass76K implements Comparator {
    ...
    public AnonymousClass76K(String str, SimpleDateFormat simpleDateFormat) {
        this.A01 = str;
        this.A02 = simpleDateFormat;
        this.A00 = simpleDateFormat.toPattern();
    }

    private Date A00(File file) {
